...
if (ENVIRONMENT_IS_WEB || ENVIRONMENT_IS_WORKER) {
  if (ENVIRONMENT_IS_WORKER) {
    scriptDirectory = self.location.origin + "/";
...
var wasmBinaryFile = "media/libCompress.wasm";
...
var _create = (Module["_create"] = function () {
  return (_create = Module["_create"] = Module["asm"]["n"]).apply(
    null,
    arguments
  );
});
var _unCompressCanDataToJson = (Module["_unCompressCanDataToJson"] =
  function () {
    return (_unCompressCanDataToJson = Module["_unCompressCanDataToJson"] =
      Module["asm"]["o"]).apply(null, arguments);
  });
var _deletePtr = (Module["_deletePtr"] = function () {
  return (_deletePtr = Module["_deletePtr"] = Module["asm"]["p"]).apply(
    null,
    arguments
  );
});
