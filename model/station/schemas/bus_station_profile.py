...
@dataclass
class AbsBusStationQuotaScoreSub:
    """车辆画像指标分数子表实体类"""
...
@dataclass
class AbsBusStationSuggestedSub:
    """车辆画像建议子表实体类"""
...
@dataclass
class AbsBusStationProfileMain:
    """车辆画像主表实体类（包含子类）"""
    ...
    # 基础信息
    bus_station_id: str  # 车辆ID
    bus_station_name: str  # 车辆名称
    organ_id: str  # 机构ID
    organ_name: str  # 机构名称
...
def main():
    ...
    # 创建示例数据
    profile = AbsBusStationProfileMain(
        ppartition="20260216",
        id="profile_001",
        Bus_id="DRV001",
        Bus_name="张三",
