...
class AbsDriverQuotaScoreSub:
    ...
    def to_dict(self) -> Dict[str, Any]:
        """
        将AbsDriverQuotaScoreSub对象转换为字典格式
...
class AbsDriverProfileMain:
    ...
    def to_dict(self) -> Dict[str, Any]:
        """
        将AbsDriverProfileMain对象转换为字典格式
...
def main():
    # 示例用法
    print("驾驶员画像系统实体类定义完成")
    print("- AbsDriverProfileMain: 驾驶员画像主表实体类（包含子类）")
    print("- AbsDriverQuotaScoreSub: 驾驶员画像指标分数子表实体类")
    print("- AbsDriverSuggestedSub: 驾驶员画像建议子表实体类")

    # 创建示例数据
    profile = AbsDriverProfileMain(
        ppartition="20260216",
        id="profile_001",
        driver_id="DRV001",
        driver_name="张三",
    ...
    print(f"\n创建示例驾驶员画像: {profile.driver_name}")
    print(f"驾驶员ID: {profile.driver_id}")
